...
public class ProducerDemo {
    ...
    static private final String TOPIC = "mykafkaLearn2";
    //static private final String ZOOKEEPER = "localhost:12181";
    static private final String BROKER_LIST = "spark1234:9092";
...
//    props.put("compression.codec", "0");
    ...
    public static void sendOne(Producer<String, String> producer, String topic) throws InterruptedException {
        ...
        Thread.sleep(500);
        KeyedMessage<String, String> message2 = new KeyedMessage<String, String>(topic, "32", "test 32");
        producer.send(message2);
        Thread.sleep(500);
        KeyedMessage<String, String> message3 = new KeyedMessage<String, String>(topic, "33", "test 33");
        producer.send(message3);
        Thread.sleep(500);
        KeyedMessage<String, String> message4 = new KeyedMessage<String, String>(topic, "34", "test 34");
        producer.send(message4);
        Thread.sleep(500);
        KeyedMessage<String, String> message5 = new KeyedMessage<String, String>(topic, "35", "test 35");
